  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 p-6">
      ...
      <div className="space-y-4">
        ...
        <Link href="/producto/fallbackfalse?id=1" className="text-orange-600 hover:underline text-xl">
          🧪 fallbackfalse.tsx (fallback: false)
        </Link>
        <Link href="/producto/fallbacktrue?id=1" className="text-orange-600 hover:underline text-xl">
          🧪 fallbacktrue.tsx (fallback: true)
        </Link>
        <Link href="/producto/blocking?id=1" className="text-orange-600 hover:underline text-xl">
          🧪 blocking.tsx (fallback: 'blocking')
        </Link>
      </div>
    </div>
  );
